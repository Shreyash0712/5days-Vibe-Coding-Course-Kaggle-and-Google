# Day 4: Secure Agent Labs

This repository contains the codelabs and projects for Day 4, focusing on building and securing AI agents.
...
To run these projects, you generally need:
- **Python 3.11+**
- **uv** (Python package manager)
- **Google Cloud SDK** (`gcloud`)
- **agents-cli** (`uv tool install google-agents-cli`)

Navigate to the respective project folders to view detailed instructions on how to install dependencies and run the agents.
